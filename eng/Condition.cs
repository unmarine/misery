...
public struct Condition : IEquatable<Condition>
{
        ...
        public State Counted { get; }
        public State Resulting { get; }

        private int Min { get; }
        private int Max { get; }
        public bool IsUnconditional { get; } = false;
        ...
        {
                return
                        $"{Starting.Value} {Counted.Value} {Resulting.Value} {Min} {Max} {(IsUnconditional ? "Unconditional" : "")}";
        }
}